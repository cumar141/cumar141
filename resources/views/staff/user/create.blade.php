...
@endif
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('staff.user.store') }}" class="form-horizontal" id="user_form" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control font-size-14" placeholder="{{ __('Enter :x', ['x' => __('first name')]) }}" name="first_name" type="text" id="first_name" value="{{ old('first_name') }}" required data-value-missing="{{ __('This field is required.') }}" maxlength="30" data-max-length="{{ __(':x length should be maximum :y charcters.', ['x' => __('First name'), 'y' => __('30')]) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control font-size-14" placeholder="{{ __('Enter :x', ['x' => __('last name')]) }}" name="last_name" type="text" id="last_name" value="{{ old('last_name') }}" required data-value-missing="{{ __('This field is required.') }}" maxlength="30" data-max-length="{{ __(':x length should be maximum :y character.', ['x' => __('Last name'), 'y' => __('30')]) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control font-size-14" placeholder="{{ __('Enter a valid :x.', ['x' => __('email')] )}}" name="email" type="email" id="email" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" data-type-mismatch="{{ __('Enter a valid :x.', [ 'x' => strtolower(__('email'))]) }}">
                            @if($errors->has('email'))
                        ...
                        <div class="mb-3">
                            ...
                            <select class="select2 font-size-14" name="role" id="role" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="select2 font-size-14" name="branch_id" id="branch_id" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control font-size-14" placeholder="{{ __('Enter new Password') }}" name="password" type="password" id="password" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" minlength="4" data-min-length="{{ __(':x should contain at least :y characters.', ['x' => __('Password'), 'y' => '4']) }}">
                        ...
                        <!-- Confirm Password -->
                        <div class="mb-3">
                            <label for="password_confirmation" class="form-label require">{{ __('Confirm Password') }}</label>
                            <input class="form-control font-size-14" placeholder="{{ __('Confirm password') }}" name="password_confirmation" type="password" id="password_confirmation" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" minlength="4" data-min-length="{{ __(':x should contain at least :y characters.', ['x' => __('Password'), 'y' => '4']) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="select2 font-size-14" name="status" id="status" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                        ...
                        <div class="row">
                            <div class="col-sm-6 offset-md-3">
                                <a class="btn btn-danger font-size-14 me-1" href="{{ route('staff.user.index') }}" id="users_cancel">{{ __('Cancel') }}</a>
                                <button type="submit" class="btn btn-primary font-size-14" id="users_create"><i class="fa fa-spinner fa-spin d-none"></i> <span id="users_create_text">{{ __('Create') }}</span></button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('#user_form').validate({
            ...
            messages: {
                ...
                password: {
                    required: "{{ __('This field is required.') }}",
                    minlength: "{{ __(':x should contain at least :y characters.', ['x' => __('Password'), 'y' => '6']) }}"
                },
                password_confirmation: {
                    required: "{{ __('This field is required.') }}",
                    minlength: "{{ __(':x should contain at least :y characters.', ['x' => __('Password'), 'y' => '6']) }}",
