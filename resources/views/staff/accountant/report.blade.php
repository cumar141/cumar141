                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">
                            <i class="fa fa-money"></i> Treasury Report 
                        </h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">treasurer</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="post" action="#" id="managerForm">
                                                        @csrf
                                                        <input type="hidden" name="treasurer_id" value="{{ $user->id }}">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <select id="transaction_type" class="form-select select2" style="width: 100%;">
                            ...
                            <input type="hidden" name="treasurer_id" value="">
...
<script type="text/javascript">
    ...
    $('#managerForm, #tellerForm').submit(function(e) {
        ...
        var treasurer_id = form.find('input[name="treasurer_id"]').val();


        $('#currencyModal input[name="treasurer_id"]').val(treasurer_id);
    ...
    $('#generate_report').click(function() {
        ...
        var treasurer_id = $('#currencyModal input[name="treasurer_id"]').val();
        var teller_id = $('#currencyModal input[name="teller_id"]').val();
        var reportType = $('#transaction_type').val();
