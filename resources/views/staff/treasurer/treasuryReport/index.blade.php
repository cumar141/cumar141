...
<script type="text/javascript">
    ...
    $('#managerForm, #tellerForm').submit(function(e) {
        ...
        var manager_id = form.find('input[name="manager_id"]').val();
        var teller_id = form.find('input[name="teller_id"]').val();
        var branch_id = form.find('input[name="branch_id"]').val();

        $('#currencyModal input[name="manager_id"]').val(manager_id);
    ...
    $('#generate_report').click(function() {
        ...
        var manager_id = $('#currencyModal input[name="manager_id"]').val();
        ...
        // console.log(params);
        window.open("{{ route('treasury.report.generate') }}" +"?" + $.param(params), "", "width=1000,height=940,scrollbars=yes", "left=40");
