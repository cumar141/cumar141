    ...
    <div class="page-content">
        <div class="container-fluid">
           ...
           @elseif($transactionDetails->status == 'Blocked') text-danger @endif">
                ...
                <div class="row">
                    <div class="col-span-1">
                        Sender Name: &nbsp; &nbsp; &nbsp;&nbsp;{{ $transactionDetails->user->firts_name }}
                        {{ $transactionDetails->user->last_name }}
                    </div>
                    <div class="col-span-1">
                ...
                <div class="row">
                    <div class="col-span-1">
                        Receiver Name: &nbsp; &nbsp;
                        &nbsp;&nbsp;{{ optional($transactionDetails->end_user)->firts_name }}
                        {{ optional($transactionDetails->end_user)->last_name }}
                    </div>
                    <div class="col-span-1">
                        Receiver Phone: &nbsp; &nbsp;
                ...
                <div class="d-flex flex-row justify-content-between">
                    <div>Amount:</div>
                    <div>Total Amount:
                        {{ $transactionDetails->currency->symbol ?? '$' }}{{ number_format(str_replace('-', '', $transactionDetails->subtotal), 2) }}
                    </div>
                    <div>Comm:
                        {{ $transactionDetails->currency->symbol ?? '$' }}{{ number_format(str_replace('-', '', $transactionDetails->charge_fixed), 2) }}
                    </div>
                    <div>Net Amount:
                        {{ $transactionDetails->currency->symbol ?? '$' }}{{ number_format(str_replace('-', '', $transactionDetails->total), 2) }}
                    </div>
                </div>
                <div class="row">
                <div>
