...
@section('title', __('Add Organization wallet'))
...
@section('page_content')
    ...
    <div class="box box-info" id="user-create">
        <div class="box-header with-border">
            <h3 class="box-title">{{ __('Search  Organization wallet') }}</h3>
        </div>
        <br>
        <br>
    <div></div>
        ...
        {{-- a search form  --}}
        <form action="{{ url(config('adminPrefix').'/organization/wallet/search') }}" class="form-horizontal" id="orgSearchForm" method="POST">
