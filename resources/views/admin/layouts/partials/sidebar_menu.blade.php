<ul class="sidebar-menu mt-20">
    ...
    Common::has_permission(auth()->guard('admin')->id(), 'view_admins'))
    ...
    @endif
    @if(Common::has_permission(auth()->guard('admin')->id(), 'view_staff'))
    <li class="treeview {{ (isset($menu) && $menu == 'staff') ? 'menu-open active' : '' }}">
        <a href="#">
            <i class="fa fa-user"></i><span>{{ __('Staff') }}</span>
            <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
        </a>
        <ul class="treeview-menu">
           
            @if(Common::has_permission(auth()->guard('admin')->id(), 'view_staff'))
            <li class="child {{ isset($sub_menu) && $sub_menu == 'staff_list' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/staff') }}">
                    <i class="fa fa-user-circle-o"></i><span>{{ __('Users') }}</span>
                </a>
            </li>
            @endif
            ...
            @if(Common::has_permission(auth()->guard('admin')->id(), 'view_staff'))
            <li class="child {{ isset($sub_menu) && $sub_menu == 'role_list' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/roles') }}">
                    <i class="fa fa-user-md"></i><span>{{ __('Roles') }}</span>
                </a>
            </li>
            @endif
            @if(Common::has_permission(auth()->guard('admin')->id(), 'view_staff'))
            <li class="child {{ isset($sub_menu) && $sub_menu == 'perm_list' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/permissions') }}">
                    <i class="fa fa-user-md"></i><span>{{ __('Permissions') }}</span>
                </a>
            </li>
            @endif
        </ul>
    ...
    @endif
    @if(Common::has_permission(auth()->guard('admin')->id(), 'view_staff'))
    <li class="treeview {{ (isset($menu) && $menu == 'branch') ? 'menu-open active' : '' }}">
        <a href="#">
            <i class="fa fa-user"></i><span>{{ __('Branch') }}</span>
            <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
        </a>
        <ul class="treeview-menu">
           
            @if(Common::has_permission(auth()->guard('admin')->id(), 'view_staff'))
            <li class="child {{ isset($sub_menu) && $sub_menu == 'branch_list' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/branch') }}">
                    <i class="fa fa-user-circle-o"></i><span>{{ __('Branch') }}</span>
                </a>
            </li>
            @endif
    ...
    @if(Common::has_permission(auth()->guard('admin')->id(), 'view_staff'))
    <li class="treeview {{ (isset($menu) && $menu == 'organization') ? 'menu-open active' : '' }}">
        <a href="#">
            <i class="fa fa-user"></i><span>{{ __('Organization') }}</span>
            <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
        </a>
        <ul class="treeview-menu">
           
            @if(Common::has_permission(auth()->guard('admin')->id(), 'view_staff'))
            <li class="child {{ isset($sub_menu) && $sub_menu == 'organization_list' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/organization') }}">
                    <i class="fa fa-user-circle-o"></i><span>{{ __('Organization') }}</span>
                </a>
            </li>
            @endif
            @if(Common::has_permission(auth()->guard('admin')->id(), 'view_staff'))
            <li class="child {{ isset($sub_menu) && $sub_menu == 'organization_user_list' ? 'active' : '' }}">
                <a href="#">
                    <i class="fa fa-user-circle-o"></i><span>{{ __('Organization User') }}</span>
                </a>
            </li>
            @endif
            @if(Common::has_permission(auth()->guard('admin')->id(), 'view_staff'))
            <li class="child {{ isset($sub_menu) && $sub_menu == 'organization_wallet_list' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/organization/wallet') }}">
                    <i class="fa fa-user-circle-o"></i><span>{{ __('Organization Wallet') }}</span>
                </a>
            </li>
            @endif
            @if(Common::has_permission(auth()->guard('admin')->id(), 'view_staff'))
            <li class="child {{ isset($sub_menu) && $sub_menu == 'organization_transaction_list' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/organization/transaction') }}">
                    <i class="fa fa-user-circle-o"></i><span>{{ __('Organization Transaction') }}</span>
                </a>
            </li>
            @endif
    ...
    Common::has_permission(auth()->guard('admin')->id(), 'view_withdrawal') ||
    Common::has_permission(auth()->guard('admin')->id(), 'view_transfer') ||
    Common::has_permission(auth()->guard('admin')->id(), 'view_exchange') ||
    Common::has_permission(auth()->guard('admin')->id(), 'view_request_payment') ||
    Common::has_permission(auth()->guard('admin')->id(), 'view_transaction'))
    <li class="treeview {{ (isset($menu) && $menu == 'transaction') ? 'menu-open active' : '' }}">
        <a href="#">
            <svg id="e1WnpxAjyv41" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                width="16" class="svgicon" stroke="currentColor" viewBox="0 -20 512 512"
                shape-rendering="geometricPrecision" text-rendering="geometricPrecision">
        ...
        <ul class="treeview-menu">
            ...
            <li class="child {{ isset($sub_menu) && $sub_menu == 'transactions' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/transactions') }}"><i class="fa fa-history"></i><span>{{ __('All
                        Transactions') }}</span></a>
            </li>
            @endif
            <!-- deposits -->
            ...
            <li class="child {{ isset($sub_menu) && $sub_menu == 'deposits' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/deposits') }}"><i class="fa fa-arrow-down"></i><span>{{
                        __('Deposits') }}</span></a>
            </li>
            @endif
            ...
            <li class="child {{ isset($sub_menu) && $sub_menu == 'withdrawals' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/withdrawals') }}"><i class="fa fa-arrow-up"></i><span>{{
                        __('Withdrawals') }}</span></a>
            </li>
            @endif
            ...
            <li class="child {{ isset($sub_menu) && $sub_menu == 'transfers' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/transfers') }}"><i class="fa fa-exchange"></i><span>{{
                        __('Transfers') }}</span></a>
            </li>
            @endif
            ...
            <li class="child {{ isset($sub_menu) && $sub_menu == 'exchanges' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/exchanges') }}"><i class="fa fa-money"></i><span>{{ __('Currency
                        Exchange') }}</span></a>
            </li>
            @endif
            ...
            <li class="child {{ isset($sub_menu) && $sub_menu == 'request_payments' ? 'active' : '' }}">
                <a href="{{ url(config('adminPrefix').'/request_payments') }}"><i class="fa fa-calculator"></i><span>{{
                        __('Request Payments') }}</span></a>
            </li>
            @endif
    ...
    <li class="{{ isset($menu) && $menu == 'revenues' ? 'active' : '' }}">
        <a href="{{ url(config('adminPrefix').'/revenues') }}"><i class="fa fa-book"></i><span>{{ __('Revenues')
                }}</span></a>
    </li>
    @endif
    ...
    <li class="{{ isset($menu) && $menu == 'dispute' ? 'active' : '' }}">
        <a href="{{url(config('adminPrefix').'/disputes')}}"><i class="fa fa-ticket"></i><span>{{ __('Disputes')
                }}</span></a>
    </li>
    @endif
    ...
    <li class="{{ isset($menu) && $menu == 'ticket' ? 'active' : '' }}">
        <a href="{{url(config('adminPrefix').'/tickets/list')}}"><i class="fa fa-spinner"></i><span>{{ __('Tickets')
                }}</span></a>
    </li>
    @endif
    ...
    <li class="{{ isset($menu) && $menu == 'activity_logs' ? 'active' : '' }}">
        <a href="{{ url(config('adminPrefix').'/activity_logs') }}"><i class="fa fa-eye"></i><span>{{ __('Activity
                Logs') }}</span></a>
    </li>
    @endif
    ...
    Common::has_permission(auth()->guard('admin')->id(), 'view_address_verfication'))
    ...
    <li class="child {{ isset($menu) && $menu == 'reports' ? 'active' : '' }}">
    ...
    <li class="{{ isset($menu) && $menu == 'currency' ? 'active' : '' }}">
        <a href="{{ url(config('adminPrefix').'/settings/currency') }}"><i class="fa fa-money"></i><span>{{
                __('Currencies') }}</span></a>
    </li>
    @endif
    ...
    Common::has_permission(auth()->guard('admin')->id(), 'view_sms_template'))
    ...
    <li class="{{ isset($menu) && $menu == 'system-update' ? 'active' : '' }}">
        <a href="{{ url(config('adminPrefix') . '/system-update') }}"><i class="fa fa-cloud-upload"
                aria-hidden="true"></i><span>{{ __('System Update') }}</span></a>
    </li>
    @endif
    ...
    <li class="{{ isset($menu) && $menu == 'addon-manager' ? 'active' : '' }}">
        <a href="{{ url(config('adminPrefix') . '/module-manager/addons') }}"><i class="fa fa-puzzle-piece"></i><span>{{
                __('Addon Manager') }}</span></a>
    </li>
    @endif
