...
@section('page_content')
    ...
    <div class="box box-info" id="user-create">
        ...
        <form action="{{  url(config('adminPrefix').'/staff/store') }}" class="form-horizontal" id="user_form" method="POST">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-sm-6 offset-md-3">
                        <a class="btn btn-theme-danger f-14 me-1" href="{{  url(config('adminPrefix').'/staff') }}" id="users_cancel">{{ __('Cancel') }}</a>
