...
<div class="bg-white pxy-62 exchange pt-62 shadow" id="identitiyVerify">
    <p class="mb-0 f-26 gilroy-Semibold text-uppercase text-center">{{ __('Verfication') }}</p>
    <div class="row"> 
        <div class="col-12">
            <!-- <nav>
                ...
                <form method="post" action="{{ route('user.setting.identitiy_verify.update') }}" enctype="multipart/form-data" id="identitiyVerifyForm">
                    ...
                    <div class="mt-28 param-ref">
                        ...
                        <div class="avoid-blink">
                            <select disabled class="select2" data-minimum-results-for-search="Infinity"  name="identity_type" id="identity_type" required data-value-missing="{{ __('This field is required.') }}">
                                ...
                                <option value="passport" {{ !empty($documentVerification->identity_type) && $documentVerification->identity_type == 'birth_certificate' ? 'selected' : '' }}>{{ __('Birth Certicate') }}</option>
                            </select>
                            @error('identity_type')
                    ...
                    <div class="label-top mt-20">
                        ...
                        <input readonly type="text" class="form-control input-form-control apply-bg l-s2" name="identity_number" id="identity_number" value="{{ !empty($documentVerification->identity_number) ? $documentVerification->identity_number : '' }}" required data-value-missing="{{ __('This field is required.') }}">
                    ...
                    <div class="proof-btn-div d-flex justify-content-between mt-3">
