...
<div class="side-navbar active-nav d-flex justify-content-between flex-wrap flex-column" id="sidebar">
    <div class="bg-secondary vh-100 position-fixed d-flex flex-column w-inherit drop-parent">
        ...
        <!-- with drawal money View -->

                <li>
                    <a href="{{ route('user.withdrawal.create') }}" class="mb-1 d-flex align-items-center list-option h-46 mt-7 {{ request()->route()->named('user.exchange_money.*') ? 'text-white bg-info' : 'text-info-100' }}">
                        <span class="ms-3 mr-20">{!! menuSvgIcon('user.exchange_money.*') !!}</span>
