...
<head>
    <meta charset="UTF-8">
    <title>{{ settings('name') }} Deposit Statement</title>
    <style>
        body {
...
<body>
    <center>
        ...
        <h1 class="text-3xl font-bold mb-4">{{ settings('name') }} Deposit Statement</h1>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @endif
                    <td class="rtl">{{ number_format($transaction->total, 2) }}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="rtl"><strong>{{ number_format($totalAmount, 2) }}</strong></td>
                </tr>
            </tbody>
        </table>
