...
class StaffUserDataTable extends DataTable
{
    public function ajax(): JsonResponse
    {
        return datatables()
            ...
            ->editColumn('first_name', function ($user) {
                return $user->id ? '<a href="' . route('staff.user.edit', $user->id) . '">' . $user->first_name . '</a>' : $user->first_name;

            })
            ->editColumn('last_name', function ($user) {
                return $user->id ? '<a href="' . route('staff.user.edit', $user->id) . '">' . $user->last_name . '</a>' : $user->last_name;
            ...
            ->addColumn('action', function ($user) {
                $edit = '<a href="' . route('staff.user.edit', $user->id) . '" class="btn btn-primary btn-sm">
    ...
    public function query()
    {
        $query = User::with([
            ...
            'role:id,display_name,customer_type',
