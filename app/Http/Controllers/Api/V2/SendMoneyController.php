...
class SendMoneyController extends Controller
{
    ...
    {
        try {
             $receiverData = $this->service->validateEmail($request->receiver_email);
            if ($receiverData) {
                    $responseData = [
                ...
                return $this->okResponse($responseData, __("Success Request."));
            }
    ...
    {
        try {
            $receiverData = $this->service->validatePhoneNumber($request->receiver_phone);
            if ($receiverData) {
                    $responseData = [
                        'fullName' => $receiverData['fullName'],
                        'phone' => $receiverData['phone'],
