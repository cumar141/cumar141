...
class CurrencyExchange extends Model
{
    ...
    public function createExchangeFromTransaction($arr, $currencyExchangeId)
    {
        ...
        $transaction->balance                  = $arr['fromWallet']->balance - ($arr['amount'] + $arr['formattedChargePercentage'] + $arr['charge_fixed']);
    ...
    public function createExchangeToTransaction($arr, $currencyExchangeId)
    {
        ...
        $transaction->balance                  = ($arr['toWallet']->balance + $arr['finalAmount']);
        $transaction->status                   = 'Success';
        $transaction->save();
    }
