...
Route::group(['middleware' => ['guest:admin', 'locale', 'ip_middleware']], function () {
    ...
    // staff
    Route::get('staff', 'StaffController@index')->middleware(['permission:view_staff']);
    Route::get('staff/create', 'StaffController@create')->middleware(['permission:add_staff']);
    Route::post('staff/store', 'StaffController@store');
    Route::get('staff/view/{id}', 'StaffController@show');
    Route::get('staff/deposit/{id}', 'StaffController@showDepositForm')->name('staff.showDepositForm');
    Route::post('staff/depositMoney', 'StaffController@depositMoney')->name('staff.depositMoney');
    Route::get('staff/edit/{id}', 'StaffController@edit')->middleware(['permission:edit_staff']);
    Route::post('staff/update', 'StaffController@update');
    Route::get('staff/delete/{id}', 'StaffController@destroy')->middleware(['permission:delete_role']);
    ...
    // Merchants
    Route::get('merchants', 'MerchantController@index')->name('merchants.index')->middleware(['permission:view_merchant']);
    ...
    Route::match(['GET', 'POST'], 'merchant/search-user', 'MerchantController@searchUser')->name('merchant.search');
    Route::post('merchant/save', 'MerchantController@Save')->name('merchant.save');
    ...
    Route::post('/merchant/search-merchant-user', 'MerchantController@searchMerchantUser');
    ...
    Route::get('reports/params', 'ReportController@params')->name("admin.report.params");
    Route::get('reports/generate', 'ReportController@generate')->name("admin.report.generate");
    Route::get('/getCurrencies', 'ReportController@getCurrencies')->name('getCurrencies');
    Route::get('/getStatuses', 'ReportController@getStatuses')->name('getStatuses');
    ...
    Route::get('permissions/datatables', 'PermissionController@datatables')->name('permissions.datatables');

    // permisions
    Route::get('roles', 'RoleController@indexRole')->name('roles');
    Route::get('roles/create', 'RoleController@storeRole')->name('roles.create');
    Route::post('roles/store', 'RoleController@storeRole')->name('roles.store');
    Route::get('roles/edit/{id}', 'RoleController@editRole')->name('roles.edit');
    // Route::POST('roles/update/{}','RoleController@updateRole')->name('roles.update');
    Route::post('roles/update/{id}', 'RoleController@updateRole')->name('roles.update');
    Route::get('roles/delete/{id}', 'RoleController@deleteRole')->name('roles.delete');
    ...
    Route::get('/organization/list/user/{id}', 'OrganizationController@listUser')->name('organization.list.user');
    Route::get('/organization/add/transaction/{id}', 'OrganizationController@addTransaction')->name('organization.add.transaction');
    // Route::get('/organization/user/{id}','OrganizationController@user')->name('organization.edit');
    Route::get('/organization/delete/{id}', 'OrganizationController@destroy')->name('organization.delete');
    Route::post('/organization/assign-merchant', 'OrganizationController@assignOrganizationMerchant')->name('organization.assign');

    Route::get('/organization/user', 'OrganizationUserController@index')->name('organization.user');
    Route::post('/organization/user/store', 'OrganizationUserController@store')->name('organization.user.store');
    Route::get('/organization/user/create/{id}', 'OrganizationUserController@create')->name('organization.user.create');
    Route::post('/organization/user/update', 'OrganizationUserController@update')->name('organization.user.update');
    // Route::post('/organization/user/search', 'OrganizationUserController@search')->name('organization.user.search');
    // Route::get('/organization/user/edit/{id}', 'OrganizationUserController@edit')->name('organization.user.edit');
    // Route::get('/organization/user/delete/{id}', 'OrganizationUserController@destroy')->name('organization.user.delete');

    Route::get('/organization/wallet', 'OrganizationWalletController@index')->name('organization');
    // Route::post('/organization/wallet/store','OrganizationWalletController@store')->name('organization.wallet.store');
    // Route::get('/organization/wallet/create','OrganizationWalletController@create')->name('organization.wallet.create');
    // Route::post('/organization/wallet/search','OrganizationWalletController@search')->name('organization.wallet.search');

    Route::get('/organization/transaction', 'OrgTransactionController@index')->name('organization.transaction');
    // Route::get('/organization/transaction/show-search', 'OrgTransactionController@ShowSearch')->name('organization.transaction.show-search');
    Route::get('/organization/add/transaction/{id}', 'OrgTransactionController@addTransaction')->name('organization.add.transaction');
    Route::post('/organization/transaction/search', 'OrgTransactionController@search')->name('organization.transaction.search');
    Route::post('/organization/transaction/store', 'OrgTransactionController@store')->name('organization.transaction.store');
